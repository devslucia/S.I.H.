  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card p-5">
        <h3 className="text-sm font-medium text-brand mb-4 uppercase tracking-wide">Nuevo Control</h3>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {showConfirmVitals && parsedVitals && (
            <div className="p-3 bg-brand/10 border border-brand/30 rounded-lg">
              <p className="text-xs text-brand font-medium mb-2">Datos detectados por IA — Verificá antes de guardar:</p>
